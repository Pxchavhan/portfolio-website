        ...
        <div className="content-wrapper">
          <div className="content-center">
            ...
            <div className="cta-container">
              <a href="#portfolio" className="btn btn-primary" style={{ textDecoration: 'none' }}>
                <span>View Portfolio</span>
                <svg className="btn-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                </svg>
              </a>
              <a href="/Prachi_Chavhan_resume.pdf" download="Prachi_Chavhan_Resume.pdf" className="btn btn-secondary" style={{ textDecoration: 'none' }}>
                Download Resume
              </a>
              <a href="https://www.linkedin.com/in/pchavhan" target="_blank" rel="noopener noreferrer" className="btn btn-secondary" style={{ textDecoration: 'none' }}>
                <span>Connect</span>
